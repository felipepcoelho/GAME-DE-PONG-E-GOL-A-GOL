...
public class FuriaAtivadaDecorator extends Decorator
{

    public FuriaAtivadaDecorator(Graphics2D g, IVisualComponente visualComponente, int x, int y) {
        super(g, visualComponente, x, y);
    }
    
    public void exibir(Graphics2D g,int posicaoX,int posicaoY){
        String furiaURL = "../jogosFramework/img/modoFuriaAtivado.png"; 
        Toolkit toolkit = 
